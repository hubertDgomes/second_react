    ...
    <>
      <Container className={"py-[50px ]"}>
        ...
        <Flex className={"justify-between gap-x-[40px] mt-[60px] inline sm:flex"}>
          <div className="custom-cursor3 py-[50px] px-[75px] rounded-2xl hover:shadow-xl/30 shadow-xl/20 text-center scale-95 hover:scale-100 transition-all duration-1000 cursor-pointer">
